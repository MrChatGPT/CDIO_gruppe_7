...
def move_to_target(target_position):
    ...
    if current_y+125 < target_y - threshhold: #Hvis vores y er skarpt mindre end hvor vi skal hen-20 (hvilket burde resultere i at vi stopper cirka 20 pixels før.)
    #vi skal altså op ad /\ (robot y er mindre end target, altså er robot tættere på 0,0)
        ...
        publish_controller_data(comstop)
        return 0
    elif current_y-125 > target_y + threshhold: #Hvis vores y er skarpt større end hvor vi skal hen+20 (hvilket burde resultere i at vi stopper cirka 20 pixels før.)
