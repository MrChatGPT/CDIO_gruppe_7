...
def animate_car(canvas, car):
    move_car(canvas, car, 5, 0)  # Move the car to the right
    canvas.after(100, animate_car, canvas, car)  # Call this function again after 100 milliseconds
